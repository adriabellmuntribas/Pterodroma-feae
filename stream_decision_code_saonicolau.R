...
# Ruta i fitxers
ruta <- "/Users/adriabellmuntribas/Desktop/TFM/QGIS/Gis project/26Nreprojected/saonicolau/produced_layers/stream_NDVI/taules_NDVI"
arxius <- c(
  "4_5_saonicolau_26N_cor_est.csv",
  "5_6_saonicolau_26N_cor_est.csv",
  "6_7_saonicolau_26N_cor_est.csv",
  "7_8_saonicolau_26N_cor_est.csv",
  "8_9_saonicolau_26N_cor_est.csv"
)
...
dades <- lapply(arxius, function(fitxer) {
  read_csv(file.path(ruta, fitxer)) %>%
    ...
    mutate(threshold_range = gsub("_saonicolau_26N_cor_est.csv", "", fitxer))
}) %>% bind_rows()
